    ...
    <section class="cu-bloque" data-bloque-datos>
      ...
      <form class="cu-datos" data-form-datos>
        ...
        <div class="cu-rejilla">
          ...
          <label class="cu-campo"><span>Tu cumpleaños <small>(sin el año)</small></span>
            <span class="cu-cumple">
              <select data-d="cumple_dia" aria-label="Día de tu cumpleaños">
              ...
              <select data-d="cumple_mes" aria-label="Mes de tu cumpleaños">
