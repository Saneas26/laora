...
['2 · Movimientos','Seiko NH35A (automático)','T2 Levante','Time Module Inc. (TMI)','Fabricante/comercializador oficial. Pedir agente para España','24 rubíes, 21.600 A/h, ~41 h','Pedir cotización','No publicado','No publicado','Hong Kong','Máxima','https://www.timemodule.com/en/'],
['2 · Movimientos','Seiko NH35A (automático)','T2 Levante','namokiMODS','Venta unitaria; tiene sección mayorista','NH35A estándar','120 SGD (~80 €)','Publicado','1','Singapur','Alta','https://www.namokimods.com/products/seiko-sii-nh35a-automatic-movement'],
['2 · Movimientos','Seiko NH35A (automático)','T2 Levante','Lucius Atelier','Regulado o sin regular, envío exprés 2-4 días','NH35A','135–185 SGD (~95–130 €)','Publicado','1','Singapur','Alta','https://luciusatelier.com/products/seiko-tmi-nh35-automatic-movement-date-black'],
['2 · Movimientos','Seiko NH35A (automático)','T2 Levante','Watch&Style','Venta unitaria','NH35A','~5.100 PHP (~78 €)','Publicado','1','Filipinas','Media-alta','https://watchandstyle.net/collections/movements'],
